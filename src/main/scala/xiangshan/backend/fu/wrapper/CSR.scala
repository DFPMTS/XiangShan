  ...
  with HasCircularQueuePtrHelper with HasCriticalErrors
{
  ...
  csrMod.fromAIA.rdata.valid        := 0.U
  csrMod.fromAIA.rdata.bits.data    := 0.U
  csrMod.fromAIA.rdata.bits.illegal := 0.U
  csrMod.fromAIA.meip    := 0.U
  csrMod.fromAIA.seip    := 0.U
  csrMod.fromAIA.vseip   := 0.U
  csrMod.fromAIA.mtopei  := 0.U
  csrMod.fromAIA.stopei  := 0.U
  csrMod.fromAIA.vstopei := 0.U
